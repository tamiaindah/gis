...
<body>
    <div class="container">
        ...
        <?php
            ...
            $id=$_GET['id'];
            $sql = mysqli_query($koneksi, "select * from tbkategori_3183111039 where id_kategori='$id'");
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $nama_kategori = $_POST['nama_kategori'];
                    mysqli_query($koneksi, "update tbkategori_3183111039 set nama_kategori='$nama_kategori' where id_kategori='$id_kategori'");
