...
<body>
    <div class="container">
        ...
        <br><a class="btn btn-primary" type="submit" href="tambah_umkm.php" > [+] Tambah UMKM</a> <a class="btn btn-primary" type="submit" href="detail_umkm.php" > Detail UMKM</a>
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <td><img src="../../img_umkm/<?php echo $r['foto_umkm'] ?>" height="50" width="50"></td>
                <td>
